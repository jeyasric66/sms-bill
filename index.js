...
// Bill Counter - Server Start ஆகும் போது 1 ல இருந்து
let billCounter = 1;
...
app.get("/", (req, res) => {
    // ஒவ்வொரு தடவ Refresh பண்ணும் போதும் +1 ஆகும்
    const billNo = billCounter;
    billCounter++; // Next Bill க்கு +1
